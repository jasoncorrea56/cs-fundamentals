...
class TestPracticeDepthFirstSearch(TestDepthFirstSearch):
    ...
    def test_preorder_dfs(self, dfs_root):
        try:
    ...
    @pytest.mark.usefixtures("dfs_root")
    def test_inorder_dfs(self, dfs_root):
        try:
    ...
    @pytest.mark.usefixtures("dfs_root2")
    def test_inorder_dfs_2(self, dfs_root2):
        try:
    ...
    @pytest.mark.usefixtures("dfs_root")
    def test_postorder_dfs(self, dfs_root):
        try:
    ...
    @pytest.mark.usefixtures("dfs_root2")
    def test_postorder_dfs_2(self, dfs_root2):
        try:
    ...
    def test_get_avg_for_each_level(self, level_avg_root):
        try:
