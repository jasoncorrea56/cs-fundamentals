...
GRAPH_ADJACENCY_LIST_OUTPUT: list[str] = [
    "A:['B', 'C', 'E']",
    "B:['A', 'C', 'D']",
    "C:['A', 'B', 'D', 'E']",
    "D:['B', 'C']",
...
GRAPH_UNION_FIND_IS_CONNECTED_TESTS: list[Any] = [
    (1, 5, True),
    (5, 7, True),
    (2, 6, True),
    (3, 8, True),
...
GRAPH_UNION_FIND_UNION_TESTS: list[Any] = [
    (1, 2),
    (2, 5),
    (5, 6),
    (6, 7),
...
GRAPH_PROBLEM_NUMBER_OF_ISLANDS_2_TESTS: list[Any] = [
