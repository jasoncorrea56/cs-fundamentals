...
router = APIRouter(prefix="/patterns/sliding-window", tags=["Patterns - Sliding Window Practice"])
...
@router.post("/submit")
async def submit_sliding_window_practice(payload: MethodsOnly) -> dict[str, Any]:
